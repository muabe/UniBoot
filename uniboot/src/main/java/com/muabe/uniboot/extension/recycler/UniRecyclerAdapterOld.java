...
public abstract class UniRecyclerAdapterOld<ItemType> extends RecyclerView.Adapter<UniViewHolder<?, ?>> {
    ...
    public UniRecyclerAdapterOld(@NotNull RecyclerView recyclerView) {
        initRecyclerView(recyclerView);
    }

    public UniRecyclerAdapterOld initRecyclerView(@NotNull RecyclerView recyclerView) {
    ...
    public UniRecyclerAdapterOld initRecyclerView(@NotNull RecyclerView recyclerView, @NotNull RecyclerView.LayoutManager layoutManager) {
        this.recyclerView = recyclerView;
        recyclerView.setAdapter(this);
    ...
    public UniRecyclerAdapterOld<ItemType> addParam(Class<? extends UniViewHolder> holderClass, String key, Object value){
    ...
    @NotNull
    public UniRecyclerAdapterOld setList(@NotNull List list) {
        itemList = list;
        return this;
    }
